...
export const checkTicketStatusTransition = (fromStatus: string, toStatus: string) => {
  const allowedTransitions: Record<string, string[]> = {
    [ETicketStatus.PRICE_EVALUATION]: [ETicketStatus.PRICE_USER_ACCEPTATION, ETicketStatus.PENDING_PAYMENT],
    [ETicketStatus.PRICE_USER_ACCEPTATION]: [ETicketStatus.PENDING_PAYMENT],
