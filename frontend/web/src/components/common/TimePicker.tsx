  ...
  (
    ...
    return (
      <Input
        ...
        name={name || picker}
        className={cn(
          'focus:text-accent-foreground w-[48px] text-center font-mono text-base tabular-nums caret-transparent focus:bg-primary-200 [&::-webkit-inner-spin-button]:appearance-none',
          className
        )}
